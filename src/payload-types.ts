...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ContactContentSection".
 */
export interface ContactContentSection {
  ...
  gallery?: ContactGallery[] | null;
  id?: string | null;
  blockName?: string | null;
  blockType: 'contactContentSection';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ContactGallery".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ContactContentSection_select".
 */
export interface ContactContentSectionSelect<T extends boolean = true> {
  backgroundImage?: T;
  headline?: T;
  description?: T;
  listItems?:
  ...
  gallery?:
    | T
    | {
        contactGallery?: T | ContactGallerySelect<T>;
      };
  id?: T;
  blockName?: T;
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ContactGallery_select".
 */
export interface ContactGallerySelect<T extends boolean = true> {
  images?:
    | T
    | {
        image?: T;
