    ...
    <>
      ...
      >
        <Container className="text-center max-w-[770px]">
          ...
          <p className="">
            Yosemite village is a four-hour drive from San Francisco and
            Sacramento, five hours from Reno and six hours from Los Angeles. The
            nearest local airports are Fresno, Merced and Modesto.
          </p>
            ...
            <div className="text-background">
              ...
              <div className="table w-full mt-11">
                <AddressRow
                  label="Write Us"
                  content={
                    <Link href="mailto:yosemite@email.com">
                      yosemite@email.com
                    </Link>
                  }
                />
